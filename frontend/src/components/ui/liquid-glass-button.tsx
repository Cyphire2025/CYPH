      ...
      >
        <div
          className="absolute top-0 left-0 z-0 h-full w-full rounded-full
            bg-gradient-to-b from-white/20 via-white/[0.10] to-white/[0.04]
            shadow-[0_0_8px_rgba(255,255,255,0.15),0_6px_20px_rgba(0,0,0,0.28),inset_1px_1px_0.5px_rgba(255,255,255,0.45),inset_-1px_-1px_0.5px_rgba(255,255,255,0.2)]
        transition-all
        dark:shadow-[0_0_8px_rgba(255,255,255,0.15),0_8px_24px_rgba(0,0,0,0.4),inset_1px_1px_0.5px_rgba(255,255,255,0.5),inset_-1px_-1px_0.5px_rgba(255,255,255,0.25)]"
        />
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md"
          style={{ backdropFilter: 'url("#container-glass")' }}
        />
        <div className="pointer-events-none absolute inset-x-3 top-[1px] h-[42%] rounded-full bg-gradient-to-b from-white/40 to-transparent" />
